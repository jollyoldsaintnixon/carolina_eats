...
ActiveRecord::Schema.define(version: 2022_03_23_221625) do
  ...
  create_table "reminder_emails", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "serve_date_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["serve_date_id"], name: "index_reminder_emails_on_serve_date_id"
    t.index ["user_id"], name: "index_reminder_emails_on_user_id"
  end
